...
<a target='_blank'
  href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/global/7521188948836614144?project=kissan-465113&deploy=true'>
  Vertex AI Studio
...
<ul style="list-style-position: outside; margin-left: 1em;">
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-cropsellingrecommendation-1-17535511463/source?project=kissan-465113'
    >
      source code editor
  ...
  <li>Go to your
    <a target='_blank'
       href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/global/7521188948836614144?project=kissan-465113'
    >
  ...
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-cropsellingrecommendation-1-17535511463/security?project=kissan-465113'
    >
      Security settings
