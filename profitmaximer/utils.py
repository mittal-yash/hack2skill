...
<a target='_blank'
  href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/global/3695381065385377792?project=kissan-465113&deploy=true'>
  Vertex AI Studio
...
<ul style="list-style-position: outside; margin-left: 1em;">
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-agriculturalprofitmaximiz-1-17535752889/source?project=kissan-465113'
    >
      source code editor
  ...
  <li>Go to your
    <a target='_blank'
       href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/global/3695381065385377792?project=kissan-465113'
    >
  ...
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-agriculturalprofitmaximiz-1-17535752889/security?project=kissan-465113'
    >
      Security settings
