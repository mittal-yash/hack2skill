...
# Custom theme for the app with green background applied.
custom_theme = gr.themes.Default(
    primary_hue=google_blue_color_hue,
    secondary_hue=google_blue_color_hue,
    font=[gr.themes.GoogleFont("Google Sans")]
).set(
    body_background_fill="#E8F5E9",  # light green background
    body_background_fill_dark="#1B5E20",  # dark green for dark mode
